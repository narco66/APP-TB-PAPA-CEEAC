...
@section('title', 'Nouvelle ligne budgétaire')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-100">
            <h1 class="text-xl font-bold text-gray-900">Nouvelle ligne budgétaire</h1>
        ...
        <form method="POST" action="{{ route('budgets.store', $papa) }}" class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="source_financement" required
                        ...
                        <option value="contribution_etat_membre"      {{ old('source_financement') === 'contribution_etat_membre' ? 'selected' : '' }}>Contribution État membre</option>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Libellé de la ligne <span class="text-gray-400 font-normal">(optionnel)</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Action prioritaire rattachée <span class="text-gray-400 font-normal">(optionnel)</span></label>
