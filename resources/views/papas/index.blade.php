                ...
                <div class="flex items-start justify-between flex-wrap gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center space-x-3 mb-1">
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-medium bg-{{ $papa->couleurStatut() }}-100 text-{{ $papa->couleurStatut() }}-700">
                                {{ $papa->libelleStatut() }}
                            </span>
                ...
                <div class="mt-3 grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <div class="h-1.5 bg-gray-100 rounded-full">
                            <div class="h-full rounded-full transition-all" style="width: {{ min(100, $papa->taux_execution_physique) }}%; background: {{ $papa->taux_execution_physique >= 75 ? '#22c55e' : ($papa->taux_execution_physique >= 50 ? '#f59e0b' : '#ef4444') }}"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center justify-between text-xs text-gray-400 mb-1">
                        ...
                        <div class="h-1.5 bg-gray-100 rounded-full">
                            <div class="h-full bg-green-400 rounded-full" style="width: {{ min(100, $papa->taux_execution_financiere) }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
